/**
 * Ported from macaly/almostnode (MIT, 6ab61f31) — 77 cases; see test/compat/LICENSE-almostnode
 *
 ...
 * against is ours — src/modules/core.ts's `utilModule` (the `util` package plus the shapes Node adds).
 *
...
import { utilModule } from "../../src/modules/core.js";
import { api, assert } from "./common.js";

const util = api(utilModule());
const {
  format,
  inspect,
  inherits,
...
describe('util module (Node.js compat)', () => {
  describe('util.format()', () => {
    ...
    describe('number formatting', () => {
      // SKIP: almostnode truncates %d; Node's format() prints Number(x) whole ('42.5'), and so do we
      it.skip('should format %d as integer', () => {
  ...
  describe('util.inspect()', () => {
    describe('primitives', () => {
      ...
      // SKIP: almostnode prints '42'; Node prints '42n', and so do we
      it.skip('should inspect bigint', () => {
  ...
  describe('util.inherits()', () => {
    ...
    // SKIP: almostnode's inherits() tolerates undefined; Node throws ERR_INVALID_ARG_TYPE, and so do we
    it.skip('should handle undefined superCtor gracefully', () => {
      function Child() {}
      // Should not throw
  ...
  describe('util.deprecate()', () => {
    ...
    // SKIP: almostnode's deprecate() calls console.warn; Node's emits a process warning to stderr, and the `util` package's does neither
    it.skip('should warn on first call', () => {
    ...
    // SKIP: same: deprecate() goes to a process warning here, not console.warn
    it.skip('should only warn once', () => {
      const consoleWarn = vi.spyOn(console, 'warn').mockImplementation(() => {});
  ...
  describe('Type checking functions', () => {
    ...
    describe('isBuffer()', () => {
      // SKIP: util.isBuffer(new Uint8Array()) is false in Node too
      it.skip('should return true for Uint8Array', () => {
  ...
  describe('util.types', () => {
    // SKIP: almostnode hangs the legacy util.isArray family off util.types; Node's types has only the isX for exotic objects
    it.skip('should have all type check functions', () => {
