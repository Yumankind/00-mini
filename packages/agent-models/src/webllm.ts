...
import type { ChatChunk, ChatMessage, ChatRequest, ChatResponse, ModelInfo, ModelProvider, ToolCall, ToolSchema, Usage } from "./types.js";
...
// ── The prompt-based fallback, marked as one ────────────────────────────────────────────────────
