...
/**
 * Tabler icons (outline set), inlined as raw path markup — the same component, and the same reason,
 * as packages/web-vue/src/components/TablerIcon.vue: no icon webfont, no network, works offline and
 * under a strict CSP, which is the whole point of an app that promises to run with nothing.
 *
 * EVERY `d` BELOW IS COPIED VERBATIM from @tabler/icons' own `icons/outline/<name>.svg`. The house
 * rule exists because path data typed from memory renders as nothing, and a redirect body pasted in
 * once rendered as eight glyphs of noise. If you need a new glyph, read the file — do not write it.
 */
...
const GLYPHS: Record<string, string> = {
  ...
  "plug-connected":
    '<path d="M7 12l5 5l-1.5 1.5a3.536 3.536 0 1 1 -5 -5l1.5 -1.5" /><path d="M17 12l-5 -5l1.5 -1.5a3.536 3.536 0 1 1 5 5l-1.5 1.5" /><path d="M3 21l2.5 -2.5" /><path d="M18.5 5.5l2.5 -2.5" /><path d="M10 11l-2 2" /><path d="M13 14l-2 2" />',
  ...
  // The vault and the approvals door.
  ...
  // The redesigned shell (2026-09-11): the sidebar rail, the workspace panel, the composer's
  // attach and send, the palette. Copied verbatim from @tabler/icons 3.46.0's outline set.
  paperclip:
  ...
  "layout-sidebar-left-collapse":
    '<path d="M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2l0 -12" /><path d="M9 4v16" /><path d="M15 10l-2 2l2 2" />',
  ...
  "corner-down-left": '<path d="M18 6v6a3 3 0 0 1 -3 3h-10l4 -4m0 8l-4 -4" />',
...
const inner = computed(() => GLYPHS[props.name] ?? "");
</script>
